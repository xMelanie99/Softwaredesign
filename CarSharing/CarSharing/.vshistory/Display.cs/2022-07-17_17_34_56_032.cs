...
public class Display
{
    ...
    public void ShowRegisterUser()
    {
        ...
        string username = "";
        private bool IsUserNameAcceptable(string givenUsername)
        {
            ...
            {
                Console.WriteLine("Error: Your username " + userInputUN + " is NOT alphanumerical or does already exist");
            }
        }
        ...
        while (!isUsernameAcceptable)
        {
            ...
            isUsernameAcceptable = IsUserNameAcceptable(givenUsername);
        }
