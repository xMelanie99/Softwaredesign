...
public class Display
{
    ...
    public void ShowRegisterUser()
    {
        ...
        private bool IsUserNameAcceptable()
        {
            ...
            bool isAlphanumerical = Regex.IsMatch(userInputUN, regularExpression);

            bool usernameExists = FileLogin.GetInstance().DoesUsernameExist(userInputUN);
            ...
            {
                string errorMessage = "Error: Your username " + userInputUN + " is NOT alphanumerical or does already exist";
